...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Admin Ticket Management <small>Function to management ticket from client</small></h1>
	<!-- end page-header -->
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
				    <table id="dg" class="easyui-datagrid" style="width:100%;min-height:400px"
				            url="<?php echo base_url(); ?>index.php/admin_ticket/page_list_rest"
