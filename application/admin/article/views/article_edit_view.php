	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('article/update/'.@$id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Title*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'title','class' => 'form-control','required' => 'required','value' => @$item->result()[0]->TITLE)); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Kategori') ?></td>
							<td><?php echo form_dropdown('category_article_id', @$article_category, @$item->result()[0]->ARTICLE_CATEGORY_ID, 'class="form-control"'); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Article*') ?></td>
							<td><?php echo form_textarea(array('id'=>'content_article','type' => 'text', 'name' => 'content','class' => 'form-control','value' => @$item->result()[0]->CONTENT)); ?></td>
						</tr>
						<tr>
