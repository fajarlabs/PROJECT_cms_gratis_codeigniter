	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('article_category/save',array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Category Name*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'category_name','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
