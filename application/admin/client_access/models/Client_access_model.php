...
class Client_access_model extends CI_Model {

	private $table = "APP_CLIENT_ACCESS";

	/**
	 * fungsi untuk mengambil function access berdasarkan username dan menu id
	 */
    public  function get_client_access_by_name_menu_id($name='',$menu_id=0) {
		$this->db->select('*');
     ...
     */
    public function delete_client_access_by_name($name)
    {
		$this->db->where('NAME', $name);
