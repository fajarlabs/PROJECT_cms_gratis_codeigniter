...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Client Access <small>Form to edit menu permissions</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="background:#f1f1f1;overflow-x: hidden;">
                	<br />
						<form id="form_client_access_edit" class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/client_access/update/<?php echo $group_id; ?>">
