...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Client Menu Management <small>Function to edit client</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
					<form id="userRegisterForm" method="post" action="<?php echo base_url(); ?>index.php/client_menu/update/<?php echo @$id; ?>">

						<table class="table table-striped  table-bordered">
							<tr>
								<td width="150px" style="padding-top:15px;"><?php echo form_label('Reference') ?></td>
								<td><?php echo form_input(array('type' => 'text','style'=>'width: 100%; height: 35px;', 'name' => 'reference','class' => 'easyui-combotree form-control', 'data-options' => 'url:\''.base_url().'index.php/client_menu/list_client_menu_ref_rest\',method:\'get\',label:\'Select Menu Reference\',labelPosition:\'top\',value:\''.@$item->result()[0]->REFERENCE.'\'')); ?></td>
							</tr>
							<tr>
