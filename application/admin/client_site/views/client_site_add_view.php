...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Client Site Management <small>Function to create client site</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('client_site/save',array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Client Site Name*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'client_site_name','class' => 'form-control','required' => 'required','placeholder' => 'Title')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Client Logo*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'client_logo','class' => 'form-control','required' => 'required','placeholder' => 'URL Image Logo')); ?>
						...
						<tr>
							...
							<td><?php echo form_input(array('type' => 'text', 'name' => 'client_logo_width','class' => 'form-control','required' => 'required','placeholder' => '.px')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Client Logo Height*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'client_logo_height','class' => 'form-control','required' => 'required','placeholder' => '.px')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Client Wallpaper*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'client_wallpaper','class' => 'form-control','required' => 'required','placeholder' => 'URL Image Wallpaper')); ?>
									<a onclick="showModalFileManager()" style="margin-top:3px;" class="btn btn-xs btn-primary" href="javascript:;">
									   <i class="fa fa-copy"></i> Change URL from File Manager
									</a>
							</td>
