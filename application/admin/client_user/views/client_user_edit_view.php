	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                	<br />
                	<?php 
                	echo form_open_multipart('client_user/update/'.@$id,array('id' => 'form_add')); ?>
					<table class="table table-striped table-bordered">
						...
						<tr>
							...
							<td><?php echo form_input(array('type' => 'text', 'value' => @$item->result()[0]->EMAIL, 'name' => 'email','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Firstname*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'value' => @$item->result()[0]->FIRST_NAME , 'name' => 'firstname','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Lastname') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'value' => @$item->result()[0]->LAST_NAME , 'name' => 'lastname','class' => 'form-control')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Phone') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'value' => @$item->result()[0]->PHONE, 'name' => 'phone','class' => 'form-control')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Password*') ?></td>
							<td><?php echo form_input(array('type' => 'password', 'name' => 'password','class' => 'form-control')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Confirm Password*') ?></td>
							<td><?php echo form_input(array('type' => 'password', 'name' => 'confirm_password','class' => 'form-control')); ?></td>
						</tr>
						<tr>
							...
							echo form_dropdown('client_site_id', $client_site_array, @$item->result()[0]->CLIENT_SITE_ID, 'class="form-control"'); ?></td>
						</tr>
						<tr>
							...
							echo form_dropdown('function_access', $dropdown_user_group, @$item->result()[0]->FUNCTION_ACCESS, 'class="form-control"'); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo form_textarea(array('name' => 'remark','value' => @$item->result()[0]->REMARK, 'class' => 'form-control')) ?></td>
						</tr>
						<tr>
							...
							<td>
								...
								<?php echo br(); ?>
								<a data-lightbox="roadtrip" class="btn btn-xs btn-success" href="<?php echo base_url(); ?>uploads/profile/<?php echo @$item->result()[0]->PHOTO; ?>"><i class="fa fa-picture-o"></i> Click to display photo</a>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
							<?php echo anchor('/client_user','Back', array('title' => 'Back to client user list', 'class' => 'btn btn-sm btn-primary')); ?>
