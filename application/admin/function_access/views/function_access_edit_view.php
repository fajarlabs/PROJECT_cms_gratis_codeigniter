...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Function Access <small>Form to edit menu permissions</small></h1>
	<!-- end page-header -->
						...
						<form id="form_function_access_edit" class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/function_access/update/<?php echo $group_id; ?>">
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									...
									?>
									<input type="text" class="form-control" id="group_name" name="group_name" value="<?php echo $row_item->GROUP_NAME; ?>" />
									<?php 
									endforeach;
									endif;
									?>
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<table id="tt" class="easyui-treegrid fixedtable"
										data-options="url:'<?php echo base_url(); ?>index.php/function_access/function_access_rest?grpus=<?php echo isset($group_id) ? $group_id : 0; ?>',method: 'get',idField:'id',treeField:'title',onLoadSuccess:function(){$('.easyui-treegrid').treegrid('expandAll');}"
										width="100%">
							...
							<div class="col-sm-offset-2 col-sm-10">
								<button type="button" class="btn btn-primary btn-sm button-back"
									onclick="window.location.href='<?php echo base_url(); ?>index.php/function_access'; return false"
									style="width: 100px">
