...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">MQTT Device Management <small>Function to edit device mqtt</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open('mqtt_device/update/'.$id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('MQTT Device Name*') ?></td>
							<td><?php echo form_input(array('value' => @$item->result()[0]->MQTT_DEVICE_NAME,'type' => 'text', 'name' => 'mqtt_device_name','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						<tr>
							...
							<td>
								<div class="row">
									<div class="col-md-12">
										<?php echo form_input(array('type' => 'text', 'name' => 'mqtt_device_topic','class' => 'form-control', 'value' => @$item->result()[0]->MQTT_DEVICE_TOPIC, 'required' => 'required')); ?>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td><?php echo form_textarea(array('value' => @$item->result()[0]->MQTT_DEVICE_DESC,'type' => 'text', 'name' => 'mqtt_device_desc','class' => 'form-control')); ?></td>
						</tr>
						<tr>
							...
							<td>
								<?php 
									...
									if ($all_device_type->num_rows() > 0) {
										foreach($all_device_type->result() as $option_item) {
											$options[$option_item->MQTT_DEVICE_TYPE_ID] = $option_item->MQTT_DEVICE_TYPE_NAME;
										}
									}
									$add_tags = array (
										'class' => 'form-control',
									...
									echo form_dropdown('mqtt_device_type', $options, @$item->result()[0]->MQTT_DEVICE_TYPE_ID ,$add_tags);
								?>
							</td>
						</tr>
						<tr>
							...
							<td>
								<?php 
									...
									echo form_dropdown('mqtt_device_subscribe', $options,  @$item->result()[0]->IS_SUBSCRIBE,$add_tags);
								?>
							</td>
						</tr>
						<tr>
							...
							<td>
								<?php 
									...
									echo form_dropdown('mqtt_device_publish', $options,  @$item->result()[0]->IS_PUBLISH ,$add_tags);
								?>
							</td>
						</tr>
