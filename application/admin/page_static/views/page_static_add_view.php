	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('page_static/save',array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						...
						<tr>
							...
							<td><?php echo form_input(array('type' => 'text', 'name' => 'url','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						<tr>
