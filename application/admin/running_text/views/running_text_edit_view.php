	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('running_text/update/'.@$id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Message*') ?></td>
							<td><?php echo form_textarea(array('type' => 'text', 'name' => 'message','class' => 'form-control','value' => @$item->result()[0]->MESSAGE)); ?></td>
						</tr>
						<tr>
							...
							<td>
								...
								$start_time = DateTime::createFromFormat('Y-m-d H:i:s', @$item->result()[0]->DISPLAY_START_TIME);
								$start_time = $start_time->format('d/m/Y H:i');
						        datetimepicker('start_time',$start_time); 
						        ?>
							</td>
						</tr>
						<tr>
							...
							<td>
								<?php
								/* convert datetime string datetime object */
								$stop_time = DateTime::createFromFormat('Y-m-d H:i:s', @$item->result()[0]->DISPLAY_STOP_TIME);
								$stop_time = $stop_time->format('d/m/Y H:i');
						        datetimepicker('stop_time',$stop_time); 
						        ?>	
							</td>
						</tr>
						<tr>
