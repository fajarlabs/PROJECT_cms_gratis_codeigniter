...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Slider Management <small>Function to create slider</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                    ...
                    <?php echo form_open_multipart('slider/save',array('id' => 'form_add')); ?>
                    <table class="table table-striped  table-bordered">
                        <tr>
                            <td width="150px" style="padding-top:15px;"><?php echo form_label('Slider Name*') ?></td>
                            <td><?php echo form_input(array('type' => 'text', 'name' => 'slider_name','class' => 'form-control','required' => 'required')); ?></td>
                        </tr>
                        <tr>
