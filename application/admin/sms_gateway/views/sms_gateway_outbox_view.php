...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">SMS Gateway <small>The function of outbox monitoring.</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">SMS Outbox - Table</h4>
                </div>
                <div class="panel-body">
				    <table id="dg" class="easyui-datagrid" style="width:100%;min-height:400px"
				            url="<?php echo base_url(); ?>index.php/sms_gateway/outbox_rest"
				        ...
				        <thead>
				            <tr>
				                ...
				                <th field="UpdatedInDB" width="20">Sending Date Time</th>
				            </tr>
				        </thead>
				    </table>
                    <div id="toolbar">
                        ...
                        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="senditems_sms()">Send Items</a>
                           <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="delete_outbox()">Delete</a>
                    </div>
