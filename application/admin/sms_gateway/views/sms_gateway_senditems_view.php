...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">SMS Gateway <small>The function of send items monitoring.</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">SMS Send Items - Table</h4>
                </div>
                <div class="panel-body">
				    <table id="dg" class="easyui-datagrid" style="width:100%;min-height:400px"
				            url="<?php echo base_url(); ?>index.php/sms_gateway/senditems_rest"
				            toolbar="#toolbar" pagination="true"
				            rownumbers="true" fitColumns="true" singleSelect="true">
				        <thead>
				            <tr>
				                <th field="DestinationNumber" width="30">Destination Number</th>
				                <th field="TextDecoded" width="30">Text Decoded</th>
				                <th field="SendingDateTime" width="20">Sending Date Time</th>
				            </tr>
				        </thead>
				    </table>
                    <div id="toolbar">
                        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="create_sms()">Create SMS</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="inbox_sms()">Inbox</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="outbox_sms()">Outbox</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="delete_senditems()">Delete</a>
                    </div>
                    <div id="dlg" class="easyui-dialog" style="width:400px;overflow-x: hidden;"
