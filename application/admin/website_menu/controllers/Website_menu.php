...
class Website_menu extends MY_Controller 
{
	public function __construct() 
	{
		parent::__construct();
		$this->load->model(array("user/User_model","user/User_group_model","website_menu/Website_menu_model"));
	...
	public function list_menu_rest()
	{
		...
		if($get_menu_ref->num_rows() > 0) {
			...
			foreach($get_menu_ref->result() as $row_menu_ref) {
				...
				if($row_menu_ref->REFERENCE == 0 || $menusc->num_rows() > 0) {
